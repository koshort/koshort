...
class Yok(object):
    ...
    def __init__(self):
        self.wiki_slangs = [
            ...
            '레기', '루저', '망나니', '매국노', '머저리', '먹사', '멍청도', '멍청이', '무뇌',
            '미제', '미치광이', '미친개', '미친놈', '미친새끼', '미친',
            '바보', '버러지', '병신', '벌레', '보슬아치',
            '보전깨', '보지', '보지년', '보추', '불한당', '븅딱', '빌어먹을', '빠가',
